...
class User(AbstractUser):
    ...
    urn_number = models.CharField(
        max_length=16,
        unique=True,
        null=True,
        blank=True)

    phone_number = models.PositiveBigIntegerField(max_length=10, unique=True, blank=True, null=True)
    ...
    tenth_school_name = models.CharField(max_length=255, blank=True, null=True)
    twelth_percentage = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    twelth_school_name = models.CharField(max_length=255, blank=True, null=True)

    current_cgpa = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True)
    active_backlogs = models.PositiveIntegerField(blank=True, null=True)
